...
from src.core.settings import SCREEN_WIDTH, SCREEN_HEIGHT, COLORS, DIFFICULTY_LEVELS
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_UP:
                    ...
                    if self.selected_index == 0:
                        ...
                        curr_idx = DIFFICULTY_LEVELS.index(self.game.config.difficulty)
                        if curr_idx > 0:
                            self.game.config.difficulty = DIFFICULTY_LEVELS[curr_idx - 1]
                            self.game.config.save()
